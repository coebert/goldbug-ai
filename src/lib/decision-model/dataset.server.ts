...
// Dealing costs actually paid on this account are measured in
// `execution-costs.server.ts`, shared with the live gate so the fit and the
// trade-time floor can never drift apart.
