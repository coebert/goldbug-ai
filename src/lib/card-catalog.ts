...
export const CARD_CATALOG: ReadonlyArray<CatalogEntry> = [
  ...
  { anchor: "fx-legs", title: "FX funding legs", page: "/portfolio/$id/risk", area: "Portfolio", keywords: "currency gbpusd close now" },
  { anchor: "cash-at-risk", title: "Cash at risk", page: "/portfolio/$id/risk", area: "Portfolio", keywords: "fx exposure budget" },
  { anchor: "stress", title: "Stress test", page: "/portfolio/$id/risk", area: "Portfolio", keywords: "worst case shock scenario" },
  { anchor: "concentration", title: "Concentration", page: "/portfolio/$id/risk", area: "Portfolio", keywords: "single name weight limit" },
